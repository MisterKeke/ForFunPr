...
// OperationContext exposes the service lifecycle context to adapters that
// create a new UI or API operation.
func (a *Service) OperationContext() context.Context {
