...
type GitRepository = service.GitRepository
type GitRepositoryListFilter = service.GitRepositoryListFilter
type GitWorkspaceCommit = service.GitWorkspaceCommit
type GitWorkspaceJob = service.GitWorkspaceJob
type GitWorkspaceJobRequest = service.GitWorkspaceJobRequest
type GitWorkspaceOperationOutcome = service.GitWorkspaceOperationOutcome
type GitWorkspaceRepositoryDetails = service.GitWorkspaceRepositoryDetails
type GitWorkspaceRoot = service.GitWorkspaceRoot
type LegacyGitWorkspaceImportPreview = service.LegacyGitWorkspaceImportPreview
type LegacyGitWorkspaceImportResult = service.LegacyGitWorkspaceImportResult
type LegacyGitWorkspaceImportRoot = service.LegacyGitWorkspaceImportRoot
type GitWorkspaceRootDeleteRequest = service.GitWorkspaceRootDeleteRequest
type GitWorkspaceSettings = service.GitWorkspaceSettings
type GitWorkspaceSettingsUpdateRequest = service.GitWorkspaceSettingsUpdateRequest
