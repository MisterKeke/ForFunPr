...
func TestCompleteMCPToolContractIsRegistered(t *testing.T) {
	...
	want := []string{
		...
		"list_favorite_categories", "create_favorite_category", "update_favorite_category", "rename_favorite_category",
		"delete_favorite_category", "reorder_favorite_categories",
		...
		"list_note_topics", "get_note_topic_board", "search_note_topic_picker", "list_note_tasks", "list_task_notes",
		"create_note_topic", "update_note_topic", "delete_note_topic", "add_note_topic_block",
		"move_note_topic_blocks", "delete_note_topic_block", "create_note_topic_connection",
		"delete_note_topic_connection", "link_note_task", "unlink_note_task",
